...
const ServiceCardOne = ({ service_name, service_details, src, slug }) => {
    ...
    return (
        <div className="service-card rounded-[10px] px-7.5 py-9 bg-transparent hover:bg-background transition-all duration-500 hover:shadow-3xl m-2.5 group/card">
            ...
            <h4 className="lg:max-w-[176px] mt-5"><Link href={{pathname: "/service-details", query: { s: slug || src }}} className="lg:text-2xl text-xl font-semibold leading-[141%] group-hover/card:text-green-foreground transition-all duration-500 ">{service_name}</Link></h4>
            <div className="card-footer opacity-0 invisible transition-all duration-500 group-hover/card:opacity-100 group-hover/card:visible">
                ...
                <Link href={{pathname: "/service-details", query: { s: slug || src }}} className="inline-flex items-center gap-2.5 lg:mt-7.5 mt-4 group/btn">
